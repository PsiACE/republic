...
out = llm.chat("Connection pool is exhausted. Give triage steps.", tape=tape.name, max_tokens=96)
...
_ = llm.chat("This time the issue is cache penetration.", tape=tape.name)
